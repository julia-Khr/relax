                            ...
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    ...
                                    <form method="POST" action="{{ route('enterprises.destroy', $enterprise) }}"
                                        ...
                                        <div class="modal fade show" id="modal-danger"
                                            style="display: block; padding-right: 16px;" aria-modal="true" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Ви дійсно хочете видалити захід {{ $enterprise->name }}? </p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-info"
                                                            data-dismiss="modal">Ні</button>
                                                        <button type="submit" class="btn btn-warning">Так</button>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                            </div>
